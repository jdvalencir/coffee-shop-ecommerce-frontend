...
const TRUST_BADGES: TrustBadge[] = [
  {
    icon: Flame,
    title: "Tostado en lotes pequeños",
    sub: "Lotes frescos cada semana",
  },
  {
    icon: Leaf,
    title: "100% origen único",
    sub: "6 regiones cafeteras premium",
  },
  {
    icon: ShieldCheck,
    title: "Pagos seguros",
                          ...
                          <div className="flex items-end justify-between gap-3">
                            <div>
                              <p className="text-[10px] font-medium uppercase tracking-wider text-white/55">
                                {product.origin} ·{" "}
                                {ROAST_LABELS[product.roastLevel]}
                              </p>
      ...
      ══════════════════════════════════════════════ */}
        ...
        <footer className="mt-16 border-t border-border/40 py-8 text-center">
          <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
            ...
            <span>© 2026 Hispania Coffee. Todos los derechos reservados.</span>
          </div>
        </footer>
      </div>
    </>
